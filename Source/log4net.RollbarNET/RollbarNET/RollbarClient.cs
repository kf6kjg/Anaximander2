...
// Copied from https://github.com/mroach/RollbarSharp as of commit 291a6c4b1f6f2d6f79dfc08dd2affd0d60f5b7c8
...
namespace RollbarNET {
	...
	public class RollbarClient : IRollbarClient {
		...
		protected void HttpPostAsync(string payload, object userParam) {
			...
			// Using Appendix Approach #-1: Actively ignore security concerns.
			// From http://www.mono-project.com/archived/usingtrustedrootsrespectfully/
			// This is because this is simply a logger, and just needs to work all the time any time.
			//request.ServerCertificateValidationCallback += (sender, certificate, chain, sslPolicyErrors) => true;
			// Bummer the above doesn't compile in Mono's NET 4.5 - even though it should.
			...
			try {
				...
				if (ex.Response == null) {
					var failMsg = string.Format("Request failed. Status: {0}. Message: {1}", ex.Status, ex.Message);
